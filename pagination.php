...
function articles(){
  ...
  for ($i = $numPage*$nbrArticleParPage-3; $i <= $numPage*$nbrArticleParPage; $i++){
    ...
    //        echo $contenu[$i]["titre"]."<br />";
    //        echo $contenu[$i]["letexte"]."<br />";
    //        echo $contenu[$i]["ladate"]."<br />";    
